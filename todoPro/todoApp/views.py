...
def home(request):
    ...
    myFilter= todoFilter(request.GET,queryset=all_todos)
    all_todos= myFilter.qs

    context={
       'todos':all_todos,'myFilter':myFilter
    }
    return render(request,'todo.html',{'todos':all_todos,'myFilter':myFilter})
